  ...
  return (
    <>
      <div className=" bg-[#FAFCFD]">
        <div className="w-20 h-20 cursor-pointer flex-shrink-0 rounded-br-[35px] bg-gradient-to-bl from-[#2399A0] to-[#2C87A4] flex items-center justify-center">
          <Bars3Icon
          ...
          <div className="col-span-1">
            <div className="relative h-[410x]">
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="relative flex-grow h-[180px]">
                  <img
        ...
        <div className="w-[300px] h-[300px] rounded-[300px] border-[80px] border-solid border-[rgba(0,0,0,0.04)] z-0 mt-[-200px] ml-[-50px]"></div>
        <div className="relative left-[430px] mb-[-220px]">
  <div className="w-[98px] h-[98px] rounded-[98px] border-[20px] stroke-[20px] order-solid border-[#FFFFFF0A] z-30"></div>
</div>

<div className="relative left-[1450px] mb-[-190px] ">
  <div className="w-[326px] h-[326px] rounded-[326px] border-[45px] stroke-[20px] order-solid border-[#FFFFFF0A] z-30"></div>
</div>


        <div className="mt-[30px] h-[470px] w-full bg-gradient-to-r from-[#3056D3] to-[#13C296]  mb-[70px]">
          ...
          <p className="text-white text-center text-[16px] not-italic font-normal leading-5 font-inter mt-6">
            ...
            <br />
            Схоже, що залишилось лише зареєструватись і розкрити його потенціал
            на повну!
          </p>
