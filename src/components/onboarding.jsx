    ...
    <>
      <div>
        <div className="bg-[#FAFCFD] overflow-hidden">
          ...
          <p className="lg:text-3xl not-italic font-semibold font-inter lg:pl-[135px] pt-[81px] sm:text-2xl sm:pl-[30px] md:text-[28px] md:pl-[50px] sm:text-[26px] inline-block">
          ...
          <div className=" first-elements lg:flex md:flex flex-row items-end lg:mx-[135px] md:mx-[50px] mt-8  sm:hidden">
            ...
            <div className="images lg:w-1/2 md:w-full flex flex-row ml-[32px] relative">
